...
#trading style
#1) Mean Reversion: Option Writing (option template) - Sideways - algotest (nifty/banknifty/finnifty/midcapnifty)
#2) Momentum: Level Based stock/buying/selling
#3) U shape --> indicator template
#www.unfluke.in -- monday

#2 Lakh  --> 1 Lakh writing  2 lakh