...
ENABLE_MARKET_HOURS = False  # Set to False to disable market hours restriction and Set to True to enable market hours restriction
...
file_map = {
    "NIFTY50": ("instrument_data_n2_nifty50_n2_noRE.csv", niftyList),
    "BANKNIFTY": ("instrument_data_n2_banknifty_n2_noRE.csv", bankNiftyList),
    "FINNIFTY": ("instrument_data_n2_finnifty_n2_noRE.csv", finNiftyList),
}
