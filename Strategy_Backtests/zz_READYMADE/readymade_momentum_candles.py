...
while x == 1:
    ...
    if dt1.second <= 1 and dt1.minute % timeFrame == 0:
        ...
        if st==0:
            ...
            if close[-1] > opens[-1] and close[-2] > opens[-2] and close[-3] > opens[-3] and high[-1] > high[-2] and high[-2] > high[-3]:
                sl=float(close[-1])-sl_point  #sl = low[-3]
            ...
            if close[-1] < opens[-1] and close[-2] < opens[-2] and close[-3] < opens[-3] and low[-1] < low[-2] and low[-2] < low[-3]:
        ...
        #IN BUY TRADE
            ...
            if close[-1]<=sl:
                ...
                if tradeOption == 1:
                    ...
                    oidexit = placeOrder1( stock, "SELL", qty, "MARKET", 0, "regular",papertrading)  #equity
            elif close[-1] < opens[-1] and close[-2] < opens[-2] and close[-3] < opens[-3] and low[-1] < low[-2] and low[-2] < low[-3]:
                st=0
        ...
        #IN SELL TRADE
            ...
            if close[-1]>=sl:
                ...
                if tradeOption == 1:
                    ...
                    oidexit = placeOrder1( stock, "BUY", qty, "MARKET", 0, "regular",papertrading)  #equity
            elif close[-1] > opens[-1] and close[-2] > opens[-2] and close[-3] > opens[-3] and high[-1] > high[-2] and high[-2] > high[-3]:
                st=0
